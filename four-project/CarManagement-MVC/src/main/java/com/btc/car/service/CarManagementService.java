...
public class CarManagementService {
	...
	public CarModel addCarDetails(CarModel carInfo) {
		CarModel savedCar = rt.postForObject(apiUrl +"/Car" , carInfo, CarModel.class);
		return savedCar;
	}

	
//	public CarModel addCarDetails(CarModel carInfo) {
//	CarModel savedCar = rt.postForObject(apiUrl +"/cars" , carInfo, CarModel.class);
//	return savedCar;
//}
	...
	// update
	public CarModel updateCarDetails(CarModel carInfo) {
	...
	public List<CarModel> getAllCarList() {
		CarModel[] carList = rt.getForObject(apiUrl, CarModel[].class);//store cars in  array
		return Arrays.asList(carList);// here we are converting  a arrays into the list
	}
